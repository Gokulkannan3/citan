...
import './home.css'
import employee from "../../components/images/ups-home.png"
import parcel from "../../components/images/parcel.png"
import employee1 from "../../components/images/emp.png"
function Home() {
  return (
...
<div className="hero  bg-white mt-8">
  <div className="hero-content flex-col lg:flex-row text-left">
    ...
    <img src={employee1} alt="pic" className="w-1/2 h-sm rounded-lg shadow-2xl" />
  </div>
</div>
